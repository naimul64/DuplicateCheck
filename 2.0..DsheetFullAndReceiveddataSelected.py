...
tableDropQuery = "DROP TABLE IF EXISTS bugs.sameMobieNoCountBetweenDssheetFullRecvddataSelected"
cursor.execute(tableDropQuery)
db.commit()

tableCreateQuery = """
    CREATE TABLE bugs.sameMobieNoCountBetweenDssheetFullRecvddataSelected (
...
schoolCodeList = open("schoolCodeListReceiveddata.txt").readlines()
...
for schoolCode in schoolCodeList:
    ...
    for rownow in resultNow:
        ...
        queryNow = """
             INSERT INTO sameMobieNoCountBetweenDssheetFullRecvddataSelected (
             ds_school_code,
            rd_school_code,
